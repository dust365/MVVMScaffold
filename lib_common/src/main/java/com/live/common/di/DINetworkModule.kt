...
//import com.live.lsg.core.BuildConfig
import com.live.core.constant.VersionStatus
import com.live.common.constant.NetBaseUrlConstant
import com.live.core.BuildConfig
...
class DINetworkModule {
    ...
    fun provideOkHttpClient(): OkHttpClient {
        // 日志拦截器部分
        val level = if (BuildConfig.VERSION_TYPE != com.live.core.constant.VersionStatus.RELEASE) BODY else NONE
