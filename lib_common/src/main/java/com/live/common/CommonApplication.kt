...
import com.live.core.BaseApplication
import com.live.core.app.ApplicationLifecycle
import com.live.core.utils.ProcessUtils
import com.live.core.utils.SpUtils
import com.live.core.utils.network.NetworkStateClient
...
class CommonApplication : ApplicationLifecycle {
    ...
    private fun initARouter(): String {
        ...
        if (BuildConfig.VERSION_TYPE != com.live.core.constant.VersionStatus.RELEASE) {
    ...
    private fun initTencentBugly(): String {
        ...
        CrashReport.initCrashReport(
            ...
            BuildConfig.VERSION_TYPE != com.live.core.constant.VersionStatus.RELEASE
        )
