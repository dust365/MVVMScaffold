package com.live.core.utils.status.imp

import android.os.Bundle
import com.live.core.utils.status.ViewStatusHelper
...
open class BaseFrameViewStatusHelperImp(parentViewStatusHelper: ViewStatusHelper? = null) : ViewStatusHelper(parentViewStatusHelper) {
     ...
     */
    private val KEY_RECREATE = "com.live.core.app.utils.status.BaseFrameViewStatusHelperImp.Recreate"
